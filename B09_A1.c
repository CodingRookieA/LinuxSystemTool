...
//Return the amount of time CPU is on
...
/*
Initialize and return a chat matrix with the given parameters
...
//Print the number of logical cores on the machine
void print_Core(){
    int i, j;
...
int main(int argc, char** argv){
    ...
    if(argc == 2){
        if(strcmp(argv[1], "--memory") == 0){
            ...
            fprintf(stderr, "Invalid argument for the program: %s", argv[1]);
            return 1;
        }
    }
